...
def load_events():
    ...
    with open('data_generation/cosmo_events_e.txt','r') as f:
        lines = f.readlines()[1:]
    ################################################################################################
...
gen_leadtime_netcdf(events, '//vs-grp07.zih.tu-dresden.de/howa/work/students/Mohamed_Elghorab/netCDFs/fertig/cosmod2eps.nc','cosmod2eps')