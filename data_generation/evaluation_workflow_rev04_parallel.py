...
def evaluate():
    ...
    cats = ['Mügliz', "Weiße Elster", 'Mandau']
    ...
    # futures = [executor.submit(evaluate_single, cat) for cat in cats]
    ...
    # Apply the evaluate_single function to each catchment in parallel
    final = pool.map(evaluate_single, cats)
...
if __name__ == '__main__':
    ...
    # logging.basicConfig(level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s') # showing the inline logging messages
    evaluate()
