...
def evaluate_for_catchment(cats):
    ...
    for lead in range(3,max_lead+1,3):
        ...
        for x in variables[:2]:
            ...
            con_csi_dic[x][c] = CONT(lib_ic['radar'], lib_ic[x],threshold).csi(50)*100
        ...
        con_csi_dic[variables[2]][c] = CONT(lib_cos['radar'], lib_cos[variables[2]],threshold).csi(50)*100
        ...
        con_csi_dic[variables[-1]][c] = CONT(lib_coseps['radar'], lib_coseps[variables[-1]],threshold).csi(50)*100
