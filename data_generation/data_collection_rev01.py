...
def create_radar(file):
    ...
    fr_to_netcdf_tools.radolantoNetCDF(t, datafolder="//vs-grp08.zih.tu-dresden.de/hwstore/RadolanRW/",
                    ...
                    outputfile="{}/Data/radRW_COS.nc".format(os.getcwd()))
...
# tic = time.time()
# create_icond2('in/Icon_events.txt',"D")
# print((time.time()-tic)/3600) # operation time in hours


# tic = time.time()
# create_icond2('in/Icon_events.txt',"eps")
# print((time.time()-tic)/3600) # operation time in hours


tic = time.time()
create_Cosmo('in/Cosmo_events.txt',"D")
print((time.time()-tic)/3600) # operation time in hours


tic = time.time()
create_Cosmo('in/Cosmo_events.txt',"eps")
print((time.time()-tic)/3600) # operation time in hours
