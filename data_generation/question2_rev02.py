...
def plot_curves(results, catchment_name):
    ...
    for res in list(results.keys()):
        ...
        plt.plot(leads, results[res]['ICOND2'],color = 'blue',marker='-',label='Main run | ICOND2' )
        plt.plot(leads, results[res]['ICOND2EPS'],color = 'blue',marker='--',label='Ensemble median | ICOND2' )
        
        plt.plot(leads, results[res]['COSMOD2'],color = 'orange',marker='-',label='Main run | COSMOD2' )
        plt.plot(leads, results[res]['COSMOD2EPS'],color = 'orange',marker='--',label='Ensemble median | COSMOD2' )
