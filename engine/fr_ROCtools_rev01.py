...
if __name__ == '__main__':
    ...
    icond2eps = Ensemble_run("C:/netCDFs/3/3hour_icond2eps.nc").eps_extract_by_shp("shp/Mugliz/mugliz_cats.shp").avg_areal_prec()
    ...
    quans = [10,25,50,75,90]
    
    for q in quans:
        tab = ROC(rad, icond2eps,q)
        areas.append(tab.roc_auc(2.5))
        tab.plot_roc(3)
        pod.append(tab.pod[1])
        pofd.append(tab.pofd[1])
